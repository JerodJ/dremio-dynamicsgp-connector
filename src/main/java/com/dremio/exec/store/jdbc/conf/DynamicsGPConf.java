...
@SourceType(value = "DynamicsGPARP", label = "DynamicsGP",uiConfig = "dynamicsgp-layout.json")
public class DynamicsGPConf extends AbstractArpConf<DynamicsGPConf> {
  private static final String ARP_FILENAME = "arp/implementation/dynamicsgp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.dynamicsgp.DynamicsGPDriver";
